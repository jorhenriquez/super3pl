            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <div class="mb-6 flex justify-between items-center space-x-4">
                        <!-- Buscador -->
                        <form method="GET" action="{{ route('clientes.index') }}" class="flex-grow">
                            <input
                                type="text"
                                name="search"
                    ...
                    <div class="relative overflow-x-auto">
                        <table class="w-full text-sm text-left rtl:text-right text-gray-500">
                            <thead class="text-xs text-gray-700 uppercase bg-gray-50">
                                <tr>
                                    <th scope="col" class="px-6 py-3">R.U.T.</th>
                                    <th scope="col" class="px-6 py-3">Nombre</th>
                                    <th scope="col" class="px-6 py-3">Cod. Meribia</th>
                                    <th scope="col" class="px-6 py-3">Cod. Externo</th>
                                ...
                                <tr class="bg-white border-b border-gray-200">
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="flex space-x-3 items-center">
                                            ...
                                            <form action="{{ route('clientes.destroy', $cliente->id) }}" method="POST" class="inline-block" onsubmit="return confirm('¿Estás seguro de eliminar este cliente?');">
                                                @csrf
                                                @method('DELETE')
